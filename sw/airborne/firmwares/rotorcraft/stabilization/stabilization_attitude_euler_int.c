...
void stabilization_attitude_init(void)
{
  ...
  //init_second_order_low_pass_int(&filter_pitch, 10.0, 0.7071, 1.0/PERIODIC_FREQUENCY, 0.0);
...
void stabilization_attitude_run(bool  in_flight)
{
  ...
  stabilization_att_fb_cmd[COMMAND_ROLL] =
    ...
    OFFSET_AND_ROUND2((stabilization_gains.i.x  * stabilization_att_sum_err.phi), 8); //was 10

  stabilization_att_fb_cmd[COMMAND_PITCH] =
    stabilization_gains.p.y    * att_err.theta +
    stabilization_gains.d.y    * rate_err.q +
    OFFSET_AND_ROUND2((stabilization_gains.i.y  * stabilization_att_sum_err.theta), 8); //was 10

  stabilization_att_fb_cmd[COMMAND_YAW] =
    stabilization_gains.p.z    * att_err.psi +
    stabilization_gains.d.z    * rate_err.r +
    OFFSET_AND_ROUND2((stabilization_gains.i.z  * stabilization_att_sum_err.psi), 8); //was 10
...
#define CMD_SHIFT 11
  ...
  stabilization_cmd[COMMAND_YAW] =
    OFFSET_AND_ROUND((stabilization_att_fb_cmd[COMMAND_YAW] + stabilization_att_ff_cmd[COMMAND_YAW]), 8); //was 11
